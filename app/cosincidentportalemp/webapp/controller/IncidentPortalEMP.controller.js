...
sap.ui.define(
    ...
    function (Controller, MessageBox, MessageToast, JSONModel, Fragment, Dialog) {
        ...
        return Controller.extend("cosincidentportalemp.controller.IncidentPortalEMP", {
            onInit: function () {
                ...
                oRouter.getRoute("RouteIncidentPortalEMP").attachMatched(this._onObjectMatched, this);
            ...
            _onObjectMatched: function (oEvent) {
                ...
                $.ajax({
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            console.log("Success:", response);
                            // response.value[0].EmpRTW = parseInt(response.value[0].EmpRTW);
